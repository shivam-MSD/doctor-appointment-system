...
namespace DoctorAppointmentSystem.Migrations
{
    ...
    [Migration("20260804061436_AddConsentDeclaredToUserPatients")]
    partial class AddConsentDeclaredToUserPatients
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.AdminAuditLog", b =>
                {
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<DateTime?>("DoctorAssignedTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.Property<DateTime?>("AutoRescheduleDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.DoctorAuditLog", b =>
                {
                    b.Property<Guid>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.UserPassword", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.UserPatient", b =>
                {
                    ...
                    b.Property<bool>("ConsentDeclared")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.UserPushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DoctorAppointmentSystem.Domain.Entities.UserPassword", b =>
                {
                    b.HasOne("DoctorAppointmentSystem.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("DoctorAppointmentSystem.Domain.Entities.UserPassword", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
